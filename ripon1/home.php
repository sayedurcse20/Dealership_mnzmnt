...
<h5><center>পরিবেশকঃ রেকিট বেনকিজার </center></h5>
	<div class="row">
		<div class="col-md-5">
		</div>
...
if ($ra->num_rows > 0) {
	...
	$monthly_sell_sum =$monthly_sell_sum - $monthly_sell_sum * .05;
	$monthly_profit =  $monthly_profit * .05;
	$stock_value = $stock_value - $stock_value * .05;
	...
	<tr>
			...
			<td>
				...
				if ($ra->num_rows > 0) {
					...
					$online_sum = 0;
					while($row = $ra->fetch_assoc()) {
						$online_sum = $online_sum + $row['rakit_bankijer'];
					}
					echo $online_sum;
				} else {
					echo "0 results";
