...
<div class="container">
<h6><center>বিসমিল্লাহির রাহমানির রহিম</center></h3>
<h5><center>মেসার্স সরকার এন্টার প্রাইজ</center> </h1>
<h5><center>পরিবেশকঃ জে এন্ড জে </center></h4>
	<div class="row">
		<div class="col-md-5">
		</div>
...
if ($ra->num_rows > 0) {
	...
	$monthly_sell_sum =$monthly_sell_sum - $monthly_sell_sum * .075;
	$monthly_profit =  $monthly_profit * .075;
	$stock_value = $stock_value - $stock_value * .075;
	...
	<tr>
			...
			<td>
				...
				if ($ra->num_rows > 0) {
					...
					$online_sum = 0;
					while($row = $ra->fetch_assoc()) {
						$online_sum = $online_sum + $row['j_and_j'];
					}
					echo $online_sum;
				} else {
					echo "0 results";
